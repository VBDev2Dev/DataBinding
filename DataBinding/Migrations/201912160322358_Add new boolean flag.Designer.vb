...
Namespace Migrations
    ...
    Public NotInheritable Partial Class Addnewbooleanflag
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Addnewbooleanflag))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201912160322358_Add new boolean flag"
            End Get
        End Property
