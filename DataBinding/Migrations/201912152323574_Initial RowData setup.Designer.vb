...
Namespace Migrations
    ...
    Public NotInheritable Partial Class InitialRowDatasetup
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(InitialRowDatasetup))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201912152323574_Initial RowData setup"
            End Get
        End Property
